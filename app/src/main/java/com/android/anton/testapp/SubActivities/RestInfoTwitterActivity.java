...
public class RestInfoTwitterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rest_info_twitter);

        String twitter = getIntent().getStringExtra("twitter");

        Log.d("RestInfo", twitter);

        webView = (WebView) findViewById(R.id.activity_rest_info_twitter_webview);
